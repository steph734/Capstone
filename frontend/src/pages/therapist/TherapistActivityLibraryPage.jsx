...
import '../owner/OwnerGamifiedSubpages.css'

// Same catalog the owner's Activity Library shows (src/pages/owner/
// OwnerActivityLibraryPage.jsx) — every gamified activity available across
// the clinic. Therapists browse it read-only; enabling/disabling activities
// stays an owner-level action.
const ACTIVITIES = [
...
export default function TherapistActivityLibraryPage({ user, onLogout, betaTier }) {
  ...
  const filtered = useMemo(() => {
    ...
    return ACTIVITIES.filter((a) => {
      const matchesSearch = !q || a.name.toLowerCase().includes(q) || a.desc.toLowerCase().includes(q)
  ...
  return (
    <TherapistPageShell
      ...
      subtitle="Browse the gamified exercises available to assign to your patients"
    ...
    >
      <div className="ogs-head">
        <div>
          ...
          <p>Every gamified activity available across your clinic.</p>
        </div>
      </div>
