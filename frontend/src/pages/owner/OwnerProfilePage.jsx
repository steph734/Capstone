...
const STORAGE_KEY = 'owner_profile'
...
export default function OwnerProfilePage({ user, onLogout, menuItems, betaTier }) {
  ...
  return (
    <OwnerPageShell user={user} onLogout={onLogout} title="My Profile" subtitle="View and manage your clinic owner profile" icon="👤" menuItems={menuItems} betaTier={betaTier}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        <div className="trp-hero">
          ...
          <div className="trp-hero-body">
            ...
            <div className="trp-hero-badges">
              <span className="trp-badge trp-badge-teal">{profile.businessName}</span>
              <span className="trp-badge trp-badge-green">Active</span>
            </div>
            <div className="trp-hero-stats">
              <div className="trp-hero-stat"><span className="trp-hero-stat-num">5</span><span className="trp-hero-stat-lbl">Therapists</span></div>
              <div className="trp-hero-stat"><span className="trp-hero-stat-num">48</span><span className="trp-hero-stat-lbl">Patients</span></div>
              <div className="trp-hero-stat"><span className="trp-hero-stat-num">3</span><span className="trp-hero-stat-lbl">Branches</span></div>
            </div>
          </div>
        </div>
        ...
        <div className="trp-stats-strip">
          {[
            { icon: '👨‍⚕️', num: '5', lbl: 'Therapists', cls: 'trp-stat-teal' },
            { icon: '👥', num: '48', lbl: 'Patients', cls: 'trp-stat-blue' },
            { icon: '🏢', num: '3', lbl: 'Branches', cls: 'trp-stat-purple' },
            { icon: '📅', num: '186', lbl: 'Sessions / Mo', cls: 'trp-stat-amber' },
          ].map(s => (
        ...
        <div className="trp-grid">
          <div className="trp-card">
            ...
            <div className="trp-field-list">
              ...
              <Field label="Clinic Address" value={profile.address} field="address" icon="📍" {...iconProps} />
            </div>
          </div>

          <div className="trp-card">
            <h3 className="trp-card-title">Business Information</h3>
            <div className="trp-field-list">
              <Field label="Business Name" value={profile.businessName} field="businessName" icon="🏥" {...iconProps} />
              <Field label="Business License" value={profile.businessLicense} field="businessLicense" icon="📄" {...iconProps} />
              <div className="trp-field-row" style={{ alignItems: 'flex-start', paddingTop: '14px' }}>
                ...
                <div className="trp-field-body">
                  <span className="trp-field-lbl">About</span>
                  {editing
